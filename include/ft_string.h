...
extern t_ft_err		ft_strtol_m(const char *str, t_ullint max_abs, t_llint *r);
extern t_ft_err		ft_strtoi_m(const char *str, t_ullint max_abs, int *r);
extern t_ft_err		ft_strtoul_m(const char *str, \
							t_ullint max_abs, t_ullint *r);
extern t_ft_err		ft_strtou_m(const char *str, t_ullint max_abs, t_uint *r);
