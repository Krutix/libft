...
BUILD_FLAGS			+= ${addprefix -L, ${BUILD_LIBS_DIRS}}
BUILD_FLAGS			+= ${addprefix -I, ${BUILD_INC_DIRS}}
...
.PHONY:	b_exe
b_exe:		${BUILD_OBJS}
			@${CC} ${CFLAGS} ${BUILD_OBJS} ${BUILD_FLAGS} ${BUILD_LIBS} -o ${BUILD_TARGET} && \
